...
{{--                                            </div>--}}
            ...
            <section class="pb-20 relative block bg-gray-800" id="contact">
                ...
                <div class="container mx-auto px-4 lg:pt-24 lg:pb-34">
                    <div class="flex flex-wrap text-center justify-center">
                        <div class="w-full lg:w-6/12 px-4 mx-8 my-8">
                            ...
                            <p class="text-lg leading-relaxed mt-4 mb-4 text-gray-500">
                                Click my email below to shoot me a message and I will get back to you within 24 hours!
                            </p>
                            <a class="font-bold text-2xl text-white hover:underline" href="mailto:blaynebennett99@gmail.com">blaynebennett99@gmail.com</a>
                        </div>
                    </div>
                </div>
            </section>
